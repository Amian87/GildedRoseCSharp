...
namespace GildedRoseKata.Tests
{
    public class GildedRoseTests
    {
        ...
        {
            List<Item> item = new List<Item> { new Item { Name = "Aged Brie", Quality = 5, SellIn = 10 } };
            GildedRose app = new GildedRose(item);
            app.UpdateQuality();
        ...
        {
            List<Item> item = new List<Item> {new Item{Name = "Aged Brie", Quality = 7, SellIn = 0}};
            GildedRose app = new GildedRose(item);
            app.UpdateQuality();
        ...
        {
            List<Item> item = new List<Item> {new Item{Name = "Aged Brie", Quality = 50, SellIn = 3}};
            GildedRose app = new GildedRose(item);
            app.UpdateQuality();
        ...
        {
            List<Item> item = new List<Item> {new Item{Name = "Sulfuras, Hand of Ragnaros", Quality = 40, SellIn = 5}};
            GildedRose app = new GildedRose(item);
            app.UpdateQuality();
        ...
        {
            List<Item> item = new List<Item> {new Item{Name = "Backstage passes to a TAFKAL80ETC concert", Quality = 30, SellIn = 10}};
            GildedRose app = new GildedRose(item);
            app.UpdateQuality();
        ...
        {
            List<Item> item = new List<Item> { new Item { Name = "Backstage passes to a TAFKAL80ETC concert", Quality = 30, SellIn = 5 } };
            GildedRose app = new GildedRose(item);
            app.UpdateQuality();
        ...
        {
            List<Item> item = new List<Item> { new Item { Name = "Backstage passes to a TAFKAL80ETC concert", Quality = 30, SellIn = 0 } };
            GildedRose app = new GildedRose(item);
            app.UpdateQuality();
            Assert.AreEqual(0, item[0].Quality);
            Assert.AreEqual(-1, item[0].SellIn);
